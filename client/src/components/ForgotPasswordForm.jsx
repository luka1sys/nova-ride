            ...
            >
                ...
                <div className="text-center">
                    ...
                    <h2 className="text-2xl font-bold text-white tracking-tight uppercase">
                        {t("Reset")} <span style={{ color: 'rgb(254, 154, 0)' }}>{t("Password")}</span>
                    </h2>
                    <p className="mt-2 text-sm text-zinc-500 leading-snug">
                        {t("Enter your email address and we'll send a recovery link to your inbox.")}
                    </p>
                </div>

                <form className="mt-6 space-y-5" onSubmit={handleSubmit}>
                    <div className="space-y-1.5">
                        <label htmlFor="email-address" className="block text-xs font-medium text-zinc-400 ml-1 uppercase tracking-wider">
                            {t("Email Address")}
                        </label>
                    ...
                    <div className="flex flex-col items-center space-y-4 pt-2">
                        ...
                        <div className="flex items-center gap-1.5 text-[10px] text-zinc-600 uppercase tracking-tighter">
                            <ShieldCheck size={12} />
                            <span>{t("Secure recovery process")}</span>
                        </div>
                    </div>
                </form>
            </motion.div>
